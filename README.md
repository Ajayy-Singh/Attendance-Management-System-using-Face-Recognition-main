...
```bash
git clone https://github.com/Ajayy-Singh/Attendance-Management-System-using-Face-Recognition-main.git
...
For any questions or issues, feel free to contact **ajaysingh1438970@gmail.com**.
